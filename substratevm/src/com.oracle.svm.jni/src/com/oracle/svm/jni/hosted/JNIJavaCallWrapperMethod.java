...
public class JNIJavaCallWrapperMethod extends NonBytecodeStaticMethod {
    ...
    public JNIJavaCallWrapperMethod(JNICallSignature targetSignature, MetaAccessProvider metaAccess, WordTypes wordTypes) {
    ...
    public StructuredGraph buildGraph(DebugContext debug, ResolvedJavaMethod method, HostedProviders providers, Purpose purpose) {
        ...
        Signature invokeSignature = targetSignature;
    ...
    private static ValueNode createCall(JNIGraphKit kit, Signature invokeSignature, ValueNode methodId, ValueNode receiverOrClass, ValueNode nonVirtual, ValueNode[] args) {
        ...
        kit.elsePart();
        ValueNode receiverOrCreatedObject = createConstructorCall(kit, invokeSignature, methodId, declaringClass, newObjectAddress, receiverOrClass, args);
    ...
    private static ValueNode createConstructorCall(JNIGraphKit kit, Signature invokeSignature, ValueNode methodId,
        ...
        createMethodCallWithReceiver(kit, invokeSignature, declaringClass, methodAddress, receiverOrClass, args);
