...
To learn how to debug Java from GDB, see the dedicated [Debug Native Executables with GNU](../../../reference-manual/native-image/guides/debug-native-executables-with-gnu.md).
