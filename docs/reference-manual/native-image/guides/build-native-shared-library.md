...
<!-- What are the alternative (non-primary) mechanisms? -->
...
## Tips for Building a Native Shared Library with the Native Image C API
...
<!-- What's the scope for uniqueness? The whole library, or the class? -->
...
```
<!-- Why is there a name parameter to the annotation? What does it do? -->
