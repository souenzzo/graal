...
By default, Native Image generates *executables* but it can also generate [*native shared libraries*][SharedLibrary.md] and [*static executables*][StaticLinking.md].
